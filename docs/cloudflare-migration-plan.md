...
This is a historical migration document. The legacy in-memory `state/` tree and `util/chronos` utilities referenced below have since been removed in favor of the shared contracts and Cloudflare Worker room modules.
