...
export const HomeTabs: React.FC<HomeTabsProps> = props => {
    return (
        <Tabs defaultValue="lobbies" className={cn('flex h-full min-h-0 flex-col gap-4 overflow-hidden px-4 py-4 sm:px-6', props.className)}>
            ...
            <TabsContent className="mt-0 min-h-0 flex-1 overflow-hidden" value="lobbies">
                <div className="h-full min-h-0">
                    <LobbyBrowser />
                </div>
            </TabsContent>
            <TabsContent className="mt-0 min-h-0 flex-1 overflow-hidden" value="chat">
                <div className="h-full min-h-0">
                    <Chat className="h-full" scope="global" />
                </div>
            </TabsContent>
            <TabsContent className="mt-0 min-h-0 flex-1 overflow-hidden" value="online">
                <div className="h-full min-h-0">
                    <GlobalUsersList />
                </div>
            </TabsContent>
