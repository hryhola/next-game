/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 13ebebc2abc507175578d2b242ab9b23)
// Runtime types generated with workerd@1.20260317.1 2026-03-29
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import('./index')
        durableNamespaces: 'LobbyRoomDO' | 'GlobalPresenceDO'
    }
    interface Env {
        IDENTITY_DB: D1Database
        LOBBY_ROOMS: DurableObjectNamespace<import('./index').LobbyRoomDO>
        GLOBAL_PRESENCE: DurableObjectNamespace<import('./index').GlobalPresenceDO>
    }
}
...
declare var Request: {
    prototype: Request
    new <CfHostMetadata = unknown, Cf = CfProperties<CfHostMetadata>>(input: RequestInfo<CfProperties> | URL, init?: RequestInit<Cf>): Request<
        CfHostMetadata,
        Cf
    >
}
