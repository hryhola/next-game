/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ff7198ca65ea86b4c0e45cdf3ef9aa9a)
// Runtime types generated with workerd@1.20260317.1 2026-03-29 nodejs_compat
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import('./index')
        durableNamespaces: 'LobbyDO' | 'GlobalPresenceDO'
    }
    interface Env {
        ASSETS_BUCKET: R2Bucket
        IDENTITY_DB: D1Database
        LOBBIES: DurableObjectNamespace<import('./index').LobbyDO>
